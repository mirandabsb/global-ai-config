...
- Para templates completos, checklists de compliance e fluxos de trabalho, consulte o playbook em `business/legal-advisor/resources/implementation-playbook.md`. Este arquivo contém: templates de Política de Privacidade, Termos de Serviço, DPA e Cookies; checklists GDPR/LGPD/CCPA/CAN-SPAM/COPPA; e indicadores de quando escalar para revisão jurídica especializada.
